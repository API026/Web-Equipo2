...
.then(data =>{
    ...
    for(let i = 0; i<14; i++){
        ...
        .then(data=>{
            ...
            if(i == 0){
                element.innerHTML +=`<h2>TOP ANIMATION</h2><div class="spacer"></div>`
            }else if(i == 5){
                element.innerHTML +=`<h2>TOP DOCUMENTARY</h2><div class="spacer"></div>`
            }else if(i==10){
                element.innerHTML +=`<h2>TOP THRILLER</h2><div class="spacer"></div>`
            }
